...
<head>
    ...
    <title>We the People Iterum</title>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">We The People Iterum</a>
            </div>
                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img class="slide-image" src="img/wtpBanner.jpg" alt="">
                                </div>
...
// configure Zazzle Store Builder display with the following $_GET variables (overrides values in include/configuration.php)

// Show pagination controls (true or false).  These are the page numbers, <--Prev, and Next --> used to move around in a Zazzle Store.
$_GET['showPagination'] = 'true';

// Show sorting controls (true or false).
$_GET['showSorting'] = 'false';

// Show product description beneath the product image (true or false). 
